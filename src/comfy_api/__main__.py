...
def main():
    ...
    videos = comfy_client.run_workflow(args.workflow, args.seed, args.prompt, args.length, args.boomerang, args.resolution, args.lora, args.steps, args.sampler, args.scheduler)
    end_time = time.time()
